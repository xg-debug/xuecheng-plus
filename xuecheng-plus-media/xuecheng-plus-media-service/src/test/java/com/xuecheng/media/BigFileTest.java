...
public class BigFileTest {
    ...
    public void testChunk() throws IOException {
        File sourceFile = new File("d:/develop/bigfile_test/无人之岛.mp4");
    ...
    public void testMerge() throws IOException {
        ...
        //原始文件
        File originalFile = new File("d:/develop/bigfile_test/无人之岛.mp4");
        //合并文件
        File mergeFile = new File("d:/develop/bigfile_test/无人之岛01.mp4");
        if (mergeFile.exists()) {
            mergeFile.delete();
        }
        //创建新的合并文件
        ...
        for (int i = 0; i < files.length; i++) {
            try {
                UploadObjectArgs uploadObjectArgs = UploadObjectArgs.builder()
                        .bucket("testbucket") // 桶
                        .filename("D:\\develop\\bigfile_test\\chunk\\"+i) // 指定本地文件路径: 或者files[i].getAbsolutePath()
                        .object("chunk/" + i)
                        .build();
